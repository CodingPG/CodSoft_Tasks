...
public class Main {
    private static final String API_KEY = "c5261aa0c176a5fd383099671a4362c0";
    private static final String API_URL = "https://api.apilayer.com/fixer/latest?access_key=" + API_KEY;

    public static double getExchangeRate(String baseCurrency, String targetCurrency) throws IOException {
        String urlString = API_URL + "&base=" + baseCurrency;
        ...
        // Fix: Get rates from "rates" instead of "conversion_rates"
